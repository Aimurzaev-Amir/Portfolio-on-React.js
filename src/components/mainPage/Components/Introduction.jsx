...
let Introduction = () => {
  return (
    <div className={stl.intro + " " + stl.wrapper} id="intro">
      <div className={stl.titleLines + " " + stl.titleLines1}>
        <hr className={stl.line} />
        <div className={stl.title}>
          <h2 className={stl.title1}>A brief Introduction</h2>
        </div>
        <hr className={stl.line} />
      </div>
      <div className={stl.introText} data-aos="fade-up" data-aos-duration="2000">
        <p>
      ...
      <div className={stl.buttonPage} >
        <a href="about-me.html">
          <button className={stl.buttonRMargin}>LEARN MORE ABOUT ME</button>
        </a>
        <form method="get" action="Aimurzayev-Amir-front-end-summary.docx">
          <button type="submit" className={stl.downloadBtn}>
            <svg
              width="19"
              height="14"
              viewBox="0 0 19 14"
